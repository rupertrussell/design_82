...
boolean displayDesignLines = true;
...
void setup() {
  ...
  ellipseMode(CENTER);
  noFill();
  beginRecord(PDF, "design_82_v023.pdf");
...
void draw() {
  ...
  step7a(displayGuideLines);
  step7b(displayGuideLines);
  step8a(displayGuideLines);
  step8b(displayGuideLines);

  step9a(displayGuideLines);
  step9b(displayGuideLines);

  step10(displayGuideLines);
  step11(displayGuideLines);

  // Dispay Design Lines
  designWeight = designWeightScale;
  step12(displayDesignLines, 0, 0, 0, designWeight);
  step13(displayDesignLines, 0, 0, 0, designWeight);
  step14(displayDesignLines, 0, 0, 0, designWeight);
  step15(displayDesignLines, 0, 0, 0, designWeight);

  designWeight = designWeightScale /2;
  step12(displayDesignLines, 255, 0, 0, designWeight);
  step13(displayDesignLines, 255, 0, 0, designWeight);
  step14(displayDesignLines, 255, 0, 0, designWeight);
  step15(displayDesignLines, 255, 0, 0, designWeight);
  
  designWeight = designWeightScale /8;
  step12(displayDesignLines, 255, 255, 0, designWeight);
  step13(displayDesignLines, 255, 255, 0, designWeight);
  step14(displayDesignLines, 255, 255, 0, designWeight);
  step15(displayDesignLines, 255, 255, 0, designWeight);

  // showTestPoint();
  // numberCircles();
  // numberIntersections();

  save("design_82_v023.png");
  endRecord();
  // exit();
}
...
void step10(boolean displayGuideLines) {
  float x1, y1, x2, y2, x3, y3, x4, y4;
  ...
  x2 = saveCircleX[5];
  y2 = saveCircleY[5];
  x3 = saveIntersectionX[24];
  y3 = saveIntersectionY[24];
  x4 = saveIntersectionX[25];
  y4 = saveIntersectionY[25];
  myLineline36 = new Lineline(36, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'g', 1);  
  myLineline36.displayIntersection();

  x1 = saveIntersectionX[26];
  y1 = saveIntersectionY[27];
  x2 = saveIntersectionX[27];
  y2 = saveIntersectionY[27]; //>
  x3 = saveCircleX[6];
  y3 = saveCircleY[6];
  x4 = saveCircleX[10];
  y4 = saveCircleY[10];
  myLineline37 = new Lineline(37, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'g', 1);  
  ...
  x4 = saveIntersectionX[25];
  y4 = saveIntersectionY[25];
  myLineline38 = new Lineline(38, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 5);  
  ...
  x4 = saveCircleX[0];
  y4 = saveCircleY[0];
  myLineline39 = new Lineline(39, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'g', 1);  
  myLineline39.displayIntersection();

  float deltaX;
  float deltaY;
  // Extend parallel pairs 
  deltaX = dist(saveIntersectionX[36], saveIntersectionX[36], saveIntersectionX[37], saveIntersectionX[37]);
  deltaY = dist(saveIntersectionY[36], saveIntersectionY[36], saveIntersectionY[37], saveIntersectionY[37]);



  saveIntersectionY[36] =  saveIntersectionY[36] - deltaY;
  saveIntersectionY[37] =  saveIntersectionY[37] + deltaY;

  saveIntersectionY[38] =  saveIntersectionY[38] - deltaY;
  saveIntersectionY[39] =  saveIntersectionY[39] + deltaY;

  // Re-Calculate intersection Points for extended lines
  x1 = saveIntersectionX[36];
  y1 = saveIntersectionY[36];
  x2 = saveIntersectionX[37];
  y2 = saveIntersectionY[37];
  x3 = saveCircleX[3];
  y3 = saveCircleY[3];
  x4 = saveCircleX[5];
  y4 = saveCircleY[5];
  myLineline36 = new Lineline(36, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 1);  
  myLineline36.displayIntersection();
  ...
  x4 = saveCircleX[9];
  y4 = saveCircleY[9];
  myLineline37 = new Lineline(37, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 1);  
  myLineline37.displayIntersection();

  x1 = saveIntersectionX[38];
  y1 = saveIntersectionY[38];
  x2 = saveIntersectionX[39];
  y2 = saveIntersectionY[39];
  x3 = saveCircleX[1];
  y3 = saveCircleY[1];
  x4 = saveCircleX[3];
  y4 = saveCircleY[3];
  myLineline38 = new Lineline(38, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 1);  
  myLineline38.displayIntersection();
  ...
  x4 = saveCircleX[9];
  y4 = saveCircleY[9];
  myLineline39 = new Lineline(39, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 1);  
  myLineline39.displayIntersection();

  if (displayGuideLines) {
    line(saveIntersectionX[36], saveIntersectionY[36], saveIntersectionX[37], saveIntersectionY[37]);
    line(saveIntersectionX[38], saveIntersectionY[38], saveIntersectionX[39], saveIntersectionY[39]);
  }
}// end step10
...
void step11(boolean displayGuideLines) {
  if (displayGuideLines) {
    strokeWeight(1);
    line(saveIntersectionX[20], saveIntersectionY[20], saveIntersectionX[30], saveIntersectionY[30]);
    line(saveIntersectionX[18], saveIntersectionY[18], saveIntersectionX[22], saveIntersectionY[22]);
    line(saveIntersectionX[21], saveIntersectionY[21], saveIntersectionX[17], saveIntersectionY[17]);
    line(saveIntersectionX[23], saveIntersectionY[23], saveIntersectionX[29], saveIntersectionY[29]);
  }
}// end step11


void step12(boolean displayLines, int r, int g, int b, float designWeight) {
  float x1, y1, x2, y2, x3, y3, x4, y4;
  x1 = saveCircleX[3];
  y1 = saveCircleY[3];
  x2 = saveCircleX[9];
  y2 = saveCircleY[9];
  x3 = saveIntersectionX[20];
  y3 = saveIntersectionY[20];
  x4 = saveIntersectionX[30];
  y4 = saveIntersectionY[30];
  myLineline40 = new Lineline(40, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 1);  
  ...
  x2 = saveCircleX[11];
  y2 = saveCircleY[11];
  x3 = saveIntersectionX[16];
  y3 = saveIntersectionY[16];
  x4 = saveIntersectionX[37];
  y4 = saveIntersectionY[37];
  myLineline41 = new Lineline(41, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 1);  
  myLineline41.displayIntersection();

  if (displayDesignLines) {
    strokeWeight(designWeight);
    stroke(r, g, b);
    line(  saveIntersectionX[40], saveIntersectionY[40], saveIntersectionX[20], saveIntersectionY[20]);
    line(  saveIntersectionX[40], - saveIntersectionY[40], saveIntersectionX[20], - saveIntersectionY[20]);
    line(- saveIntersectionX[40], saveIntersectionY[40], - saveIntersectionX[20], saveIntersectionY[20]);
    line(- saveIntersectionX[40], - saveIntersectionY[40], - saveIntersectionX[20], - saveIntersectionY[20]);

    line(  saveIntersectionX[41], saveIntersectionY[41], saveIntersectionX[18], saveIntersectionY[18]);
    line(  saveIntersectionX[41], - saveIntersectionY[41], saveIntersectionX[18], - saveIntersectionY[18]);
    line(- saveIntersectionX[41], saveIntersectionY[41], - saveIntersectionX[18], saveIntersectionY[18]);
    line(- saveIntersectionX[41], - saveIntersectionY[41], - saveIntersectionX[18], - saveIntersectionY[18]);

    line(  saveIntersectionX[41], saveIntersectionY[41], saveIntersectionX[16], saveIntersectionY[16]);
    line(  saveIntersectionX[41], - saveIntersectionY[41], saveIntersectionX[16], - saveIntersectionY[16]);
    line(- saveIntersectionX[41], saveIntersectionY[41], - saveIntersectionX[16], saveIntersectionY[16]);
    line(- saveIntersectionX[41], - saveIntersectionY[41], - saveIntersectionX[16], - saveIntersectionY[16]);
  }
...
void step13(boolean displayLines, int r, int g, int b, float designWeight) {
  if (displayDesignLines) {
    strokeWeight(designWeight);
    stroke(r, g, b);
    line(saveIntersectionX[34], saveIntersectionY[34], saveIntersectionX[4], saveIntersectionY[4]);
    line(saveIntersectionX[4], saveIntersectionY[4], saveIntersectionX[33], saveIntersectionY[33]);

    line(saveIntersectionX[15], saveIntersectionY[15], saveIntersectionX[2], saveIntersectionY[2]);
    line(saveIntersectionX[2], saveIntersectionY[2], saveIntersectionX[12], saveIntersectionY[12]);

    line(saveIntersectionX[25], saveIntersectionY[25], saveIntersectionX[0], saveIntersectionY[0]);
    line(saveIntersectionX[0], saveIntersectionY[0], saveIntersectionX[27], saveIntersectionY[27]);

    line(saveIntersectionX[14], saveIntersectionY[14], saveIntersectionX[8], saveIntersectionY[8]);
    line(saveIntersectionX[8], saveIntersectionY[8], saveIntersectionX[13], saveIntersectionY[13]);

    line(saveIntersectionX[24], saveIntersectionY[24], saveIntersectionX[6], saveIntersectionY[6]);
    line(saveIntersectionX[6], saveIntersectionY[6], saveIntersectionX[26], saveIntersectionY[26]);

    line(saveIntersectionX[35], saveIntersectionY[35], saveIntersectionX[10], saveIntersectionY[10]);
    line(saveIntersectionX[10], saveIntersectionY[10], saveIntersectionX[32], saveIntersectionY[32]);
  }
}// end step13

void step14(boolean displayLines, int r, int g, int b, float designWeight) {
  float x1, y1, x2, y2, x3, y3, x4, y4;
  x1 = saveIntersectionX[22];
  y1 = saveIntersectionY[22];
  x2 = saveIntersectionX[23];
  y2 = saveIntersectionY[23];
  x3 = saveIntersectionX[25];
  y3 = saveIntersectionY[25];
  x4 = saveIntersectionX[24];
  y4 = saveIntersectionY[24];
  myLineline42 = new Lineline(42, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 1);  
  myLineline42.displayIntersection();

  if (displayDesignLines) {
    strokeWeight(designWeight);
    stroke(r, g, b);
    line(  saveIntersectionX[42], saveIntersectionY[42], saveIntersectionX[22], saveIntersectionY[22]);
    line(  saveIntersectionX[42], - saveIntersectionY[42], saveIntersectionX[22], - saveIntersectionY[22]);
    line(- saveIntersectionX[42], saveIntersectionY[42], - saveIntersectionX[22], saveIntersectionY[22]);
    line(- saveIntersectionX[42], - saveIntersectionY[42], - saveIntersectionX[22], - saveIntersectionY[22]);

    line(  saveIntersectionX[42], saveIntersectionY[42], saveIntersectionX[25], saveIntersectionY[25]);
    line(  saveIntersectionX[42], - saveIntersectionY[42], saveIntersectionX[25], - saveIntersectionY[25]);
    line(- saveIntersectionX[42], saveIntersectionY[42], - saveIntersectionX[25], saveIntersectionY[25]);
    line(- saveIntersectionX[42], - saveIntersectionY[42], - saveIntersectionX[25], - saveIntersectionY[25]);
  }
...
void step15(boolean displayLines, int r, int g, int b, float designWeight) {
  float x1, y1, x2, y2, x3, y3, x4, y4;
  x1 = saveIntersectionX[15];
  y1 = saveIntersectionY[15];
  x2 = saveIntersectionX[14];
  y2 = saveIntersectionY[14];
  x3 = saveIntersectionX[16];
  y3 = saveIntersectionY[16];
  x4 = saveIntersectionX[17];
  y4 = saveIntersectionY[17];
  myLineline43 = new Lineline(43, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 1);  
  ...
  x2 = saveIntersectionX[14];
  y2 = saveIntersectionY[14];
  x3 = saveIntersectionX[18];
  y3 = saveIntersectionY[18];
  x4 = saveIntersectionX[19];
  y4 = saveIntersectionY[19];
  myLineline44 = new Lineline(44, x1, y1, x2, y2, x3, y3, x4, y4, false, false, 'r', 1);  
  ...
  if (displayDesignLines) {
    strokeWeight(designWeight);
    stroke(r, g, b);
    line(  saveIntersectionX[43], saveIntersectionY[43], saveIntersectionX[16], saveIntersectionY[16]);
    line(  saveIntersectionX[43], - saveIntersectionY[43], saveIntersectionX[16], - saveIntersectionY[16]);
    line(- saveIntersectionX[43], saveIntersectionY[43], - saveIntersectionX[16], saveIntersectionY[16]);
    line(- saveIntersectionX[43], - saveIntersectionY[43], - saveIntersectionX[16], - saveIntersectionY[16]);

    line(  saveIntersectionX[43], saveIntersectionY[43], saveIntersectionX[15], saveIntersectionY[15]);
    line(  saveIntersectionX[43], - saveIntersectionY[43], saveIntersectionX[15], - saveIntersectionY[15]);
    line(- saveIntersectionX[43], saveIntersectionY[43], - saveIntersectionX[15], saveIntersectionY[15]);
    line(- saveIntersectionX[43], - saveIntersectionY[43], - saveIntersectionX[15], - saveIntersectionY[15]);
    ...
    line(   saveIntersectionX[44], saveIntersectionY[44], saveIntersectionX[18], saveIntersectionY[18]);
    line(   saveIntersectionX[44], - saveIntersectionY[44], saveIntersectionX[18], - saveIntersectionY[18]);
    line( - saveIntersectionX[44], saveIntersectionY[44], - saveIntersectionX[18], saveIntersectionY[18]);
    line( - saveIntersectionX[44], - saveIntersectionY[44], - saveIntersectionX[18], - saveIntersectionY[18]);

    line(   saveIntersectionX[44], saveIntersectionY[44], saveIntersectionX[14], saveIntersectionY[14]);
    line(   saveIntersectionX[44], - saveIntersectionY[44], saveIntersectionX[14], - saveIntersectionY[14]);
    line( - saveIntersectionX[44], saveIntersectionY[44], - saveIntersectionX[14], saveIntersectionY[14]);
    line( - saveIntersectionX[44], - saveIntersectionY[44], - saveIntersectionX[14], - saveIntersectionY[14]);
  }
