...
void setup() {
  ...
  ellipseMode(CENTER);
  noFill();
  beginRecord(PDF, "design_82_v022.pdf");
...
void draw() {
  ...
  // Dispay Design Lines
  step12(displayDesignLines);
  step13(displayDesignLines);
  step14(displayDesignLines);
  step15(displayDesignLines);
...
void step12(boolean displayLines) {
  float x1, y1, x2, y2, x3, y3, x4, y4;
  x1 = saveCircleX[3];
  y1 = saveCircleY[3];
  x2 = saveCircleX[9];
...
void step13(boolean displayGuideLines) {
  if (displayDesignLines) {
...
void step14(boolean displayLines) {
  float x1, y1, x2, y2, x3, y3, x4, y4;
  x1 = saveIntersectionX[22];
  y1 = saveIntersectionY[22];
  x2 = saveIntersectionX[23];
...
void step15(boolean displayLines) {
  float x1, y1, x2, y2, x3, y3, x4, y4;
